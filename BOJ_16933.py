...
def b(r,c):
    ...
    vis[r][c][k] = 1
    while q:
        r,c,result,flag,cnt = q.popleft()

        if r==N-1 and c==M-1:
            return vis[N-1][M-1][result]+cnt
